...
public class UserService {
    ...
    {
      List<Car> carsByUser = restTemplate.getForObject("http://car-service/cars/" + idUser, List.class);
    ...
    {
      List<Bike> bikesByUser = restTemplate.getForObject("http://bike-service/bikes/" + idUser, List.class);
